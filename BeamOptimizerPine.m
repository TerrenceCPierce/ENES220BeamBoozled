    ...
    for flange_height = 3/16:1/16:3/4 %9 times
        for web_width = 3/16:1/16:min(flange_width,3/4) %9 times or less
            for web_height= 3/16:1/16:2*flange_width-2*flange_height %58 times or less
                ...
                SF_shearStress = min(abs(Pine_Shear_Avg*F/shearStress_flange),abs(Pine_Shear_Avg*F/shearStress_max))/F;
                SF_shearStressGlue = min(abs(PineGlue_Shear_Avg*F/shearStress_flange),abs(PineGlue_Shear_Avg*F/shearStress_glueWeb))/F;
