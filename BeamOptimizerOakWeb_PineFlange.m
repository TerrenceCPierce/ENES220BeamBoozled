    ...
    for flange_height = 3/16:1/16:3/4 %9 times
        for web_width = 3/16:1/16:min(flange_width,3/4) %9 times or less
            for web_height= 3/16:1/16:2*flange_width-2*flange_height %58 times or less
                ...
                SF_bendStress = min(Pine_Tens_Avg/abs(bendStress_flange),Oak_Tens_Avg/abs(bendStress_web));
                SF_shearStress = min(Pine_Shear_Avg/abs(shearStress_max),Oak_Shear_Avg/abs(shearStress_flange));
